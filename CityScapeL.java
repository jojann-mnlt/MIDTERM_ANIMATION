...
public class CityScapeL {
    ...
    private Square grass1, grass2, grass3, grass4;
    ...
    public void draw(Graphics2D g2d) {
        ...
        grass1 = new Square(sideWalkX - 100 * .659, 0, 71.3, 600, Color.decode("#136d15"));
        grass1.draw(g2d);
        grass2 = new Square(grass1.getX() - 100 * .632, 0, 63.2, 600, Color.decode("#117c13"));
        grass2.draw(g2d);
        grass3 = new Square(grass2.getX()-100*.646, 0,65,  600, Color.decode("#138510"));
        grass3.draw(g2d);
